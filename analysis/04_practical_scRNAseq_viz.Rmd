...
**Note** if you see inconsistence of the ggplot2 version vs the Seurat version,
see this [github issue](https://github.com/satijalab/seurat/issues/5756). Seurat adds random
noise before plotting the violin plot.
...
ggplot2 is great but lacks native clustering implementation.
Instead, we can use `Complexheatmap` for the same visualization task but adding 
the clustering on the fly.
...
You may also take a look at the R package [scCustomize](https://samuel-marsh.github.io/scCustomize/articles/Gene_Expression_Plotting.html#custom-dotplots) which implements those functions.
